...
class DataSource {
    fun getMovies(): List<MovieLegacy> {
        return listOf(
            MovieLegacy(
    ...
    fun getMovieById(id: Int): MovieLegacy?{
    ...
    companion object {
        fun getActors(): List<ActorLegacy> {
            return listOf(
                ActorLegacy(0, R.drawable.robert_downey, "Robert Downey Jr."),
                ActorLegacy(0, R.drawable.chris_evans, "Chris Evans"),
                ActorLegacy(0, R.drawable.mark_ruffalo, "Mark Ruffalo"),
                ActorLegacy(0, R.drawable.chris_hemsworth, "Chris Hemsworth"),
                ActorLegacy(1, R.drawable.john_david_washington, "John David Washington"),
                ActorLegacy(1, R.drawable.robert_pattinson, "Robert Pattinson"),
                ActorLegacy(1, R.drawable.elizabeth_debicki, "Elizabeth Debicki"),
                ActorLegacy(1, R.drawable.kenneth_branagh, "Kenneth Branagh"),
                ActorLegacy(1, R.drawable.dimple_kapadia, "Dimple Kapadia"),
                ActorLegacy(2, R.drawable.scarlett_johansson, "Scarlett Johansson"),
                ActorLegacy(2, R.drawable.florence_pugh, "Florence Pugh"),
                ActorLegacy(2, R.drawable.david_harbour, "David Harbour"),
                ActorLegacy(2, R.drawable.o_t_fagbenle, "O.T. Fagbenle"),
                ActorLegacy(2, R.drawable.rachel_weisz, "Rachel Weisz"),
                ActorLegacy(3, R.drawable.gal_gadot, "Gal Gadot"),
                ActorLegacy(3, R.drawable.chris_pine, "Chris Pine"),
                ActorLegacy(3, R.drawable.kristen_wiig, "Kristen Wiig"),
                ActorLegacy(3, R.drawable.pedro_pascal, "Pedro Pascal")
            )
        }
        fun getActorsByMovieId(id: Int?): List<ActorLegacy>{
